...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Weapon, function (sprite, otherSprite) {
    ...
    if (guntype == 1) {
        ...
        mySprite.setImage(img`
            ...
            `)
        haspistol = true
        Gun.destroy(effects.coolRadial, 500)
        statusbar.value = 10
    } else {
        haspistol = false
    }
...
statusbars.onZero(StatusBarKind.Ammunition, function (status) {
    Reload_Weapon()
})
...
function cleanEnemys () {
    Enemys = sprites.allOfKind(SpriteKind.Enemy)
    for (let value of Enemys) {
...
Healthbar.setLabel("HP", 15)
Healthbar.attachToSprite(mySprite)
Healthbar.setColor(7, 2)
Healthbar.positionDirection(CollisionDirection.Top)
Healthbar.max = 10
tiles.setTilemap(tiles.createTilemap(hex``, img`
    . . . . . . . . . . . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . . . . . . . . . . . 
    ...
    . . . . . . . . . . . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . . . . . . . . . . . 
    `, [myTiles.transparency16,sprites.dungeon.greenOuterNorthWest,sprites.dungeon.greenOuterSouthEast,sprites.dungeon.greenOuterWest1,sprites.dungeon.greenOuterNorth0,sprites.dungeon.greenOuterSouth0,sprites.dungeon.greenOuterSouthWest,sprites.dungeon.greenOuterNorthEast,sprites.dungeon.greenOuterEast0,sprites.dungeon.floorLight1,sprites.dungeon.floorLight0], TileScale.Sixteen))
info.setLife(3)
Healthbar.value = 10
mySprite.setPosition(62, 184)
Gun.setPosition(142, 184)
statusbar = statusbars.create(20, 4, StatusBarKind.Ammunition)
statusbar.attachToSprite(mySprite, 0, 0)
statusbar.positionDirection(CollisionDirection.Left)
statusbar.setColor(8, 15)
statusbar.setLabel("Ammo", 15)
statusbar.value = 1
statusbar.max = 10
CreateEnemy()
forever(function () {
